...
char* get_genre(int genre)
{
  switch(genre)
  {
    ...
    case 100: return "Humor";
    case 101: return "Speech";
    case 102: return "Song";
    ...
    case 131: return "In the";
    case 132: return "BritPop";
    case 133: return "Negro Punk";
    ...
    case 154: return "Chill out";
    case 155: return "Downtempo";
    case 156: return "You b";
    case 157: return "EBM";
